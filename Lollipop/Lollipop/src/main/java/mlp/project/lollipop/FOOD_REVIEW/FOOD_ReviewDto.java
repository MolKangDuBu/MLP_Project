...
public class FOOD_ReviewDto extends BaseDto{
	...
	public String toString() {
		return "FOOD_ReviewDto [review_key=" + review_key + ", review_id=" + review_id + ", review_title="
				+ review_title + ", review_image1=" + review_image1 + ", review_image2=" + review_image2
				+ ", review_image3=" + review_image3 + ", review_contents=" + review_contents + ", review_wdate="
				+ review_wdate + ", review_category=" + review_category + ", review_like=" + review_like
				+ ", review_hit=" + review_hit + ", review_address=" + review_address + ", store_key=" + store_key
				+ "]";
	}
