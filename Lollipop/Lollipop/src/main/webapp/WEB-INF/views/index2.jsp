...
-->
  ...
  <link rel="stylesheet" href="resources/css/bootstrap.min.css">                                            <!-- https://getbootstrap.com/ -->
  <link rel="stylesheet" href="resources/css/fontawesome-all.min.css">                                      <!-- Font awesome -->
      ...
      <div class="row mb-5">
        <div class="col-xl-12">
          <div class="media-boxes">
            <div class="media">
              <img src="${pageContext.request.contextPath}/resources/img/insertion-140x140-01.jpg" alt="Image" class="mr-3">
            ...
            <div class="media">
              <img src="${pageContext.request.contextPath}/resources/img/insertion-140x140-02.jpg" alt="Image" class="mr-3">
            ...
            <div class="media">
              <img src="${pageContext.request.contextPath}/resources/img/insertion-140x140-03.jpg" alt="Image" class="mr-3">
              <div class="media-body tm-bg-gray">
                <div class="tm-description-box">
            ...
            <div class="media">
              <img src="${pageContext.request.contextPath}/resources/img/insertion-140x140-04.jpg" alt="Image" class="mr-3">
              <div class="media-body tm-bg-pink-light">
                <div class="tm-description-box">
            ...
            <div class="media">
              <img src="${pageContext.request.contextPath}/resources/img/insertion-140x140-05.jpg" alt="Image" class="mr-3">
              <div class="media-body tm-bg-gray">
                <div class="tm-description-box">
