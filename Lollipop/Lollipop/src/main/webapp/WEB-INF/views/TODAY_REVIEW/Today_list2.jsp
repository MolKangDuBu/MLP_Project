		...
		<div class="row mb-5">
      	  ...
      	  <%
            	List<Today_ReviewDto> list = (List<Today_ReviewDto>)request.getAttribute("TodayList");
           		for(Today_ReviewDto tempDto : list){
           %>
             ...
             <div class="tm-description-box">            			
              <h5 class="tm-text-blue"><%=tempDto.getReview_title() %></h5>
               ...
               <div class="tm-buy-box">
	             <a class="tm-bg-blue tm-text-white tm-buy" onclick="goView('<%=tempDto.getReview_key()%>')">click</a>
...
function goPage(pg){
	...
	frm.pg.value = pg;
	frm.method = "get";
	frm.action = "${pageContext.request.contextPath}/Today/list";
	frm.submit();
}
