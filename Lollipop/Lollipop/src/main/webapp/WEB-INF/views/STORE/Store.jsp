            ...
            %>
                                <a _ngcontent-sc99="" class="no-decoration container">
                                    <app-row _ngcontent-sc99="" _nghost-sc82="">
                                        <div _ngcontent-sc99="" class="img-container">
                                        <img _ngcontent-sc99=""
                                               src="${pageContext.request.contextPath}/upload/<%=tempDto.getStore_image1()%>"
                                               alt="돼지게티"
                                                onclick= "goView('<%=tempDto.getStore_key()%>')"></div>
                                        <div _ngcontent-sc99="" class="text-container">
                                            <app-row _ngcontent-sc99="" class="title" _nghost-sc82="">
                                                <p _ngcontent-sc99="" class="poi-name"   onclick= "goView('<%=tempDto.getStore_key()%>')"><%=tempDto.getStore_name()%></p>
                                              
                                                <p>
                                                    <span><%=tempDto.getStore_address()%></span> 
                                                 	
                                                    <% if (tempDto.getStore_mark().equals("N")){ %>
                                                    <img src="../../resources/Image/markoff.png" style="width:25px; height:25px;" onclick="addMarkList('<%=tempDto.getStore_key()%>')">
                                                    <button id="btnAdd" type="button" onclick="addMarkList('<%=tempDto.getStore_key()%>')">즐겨찾기 추가</button>
                                                    <%} else { %>
                                                    <img src="../../resources/Image/markon.png" style="width:25px; height:25px;" onclick="addMarkList('<%=tempDto.getStore_key()%>')">
                                                    <button id="btnDel" type="button" onclick="addMarkList('<%=tempDto.getStore_key()%>')">즐겨찾기 삭제</button>
                                                    <%} %>
                                                </p>
                                            </app-row>
...
<!-- 여기까지 리스트 추가 -->
                                ...
                                <div class="container mt-3" style="text-align:right;">
       							...
       							<button id="mymark_btn">즐겨찾기</button>
