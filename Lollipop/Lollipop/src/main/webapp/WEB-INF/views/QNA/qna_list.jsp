...
<form name="myform">
   ...
   <input type="hidden" name="qna_key" id="qna_key" value="0"/>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-sm-10 col-lg-8">
                        <div class="section_heading text-center wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                            ...
                            <div class="search">
                                <input type="text" id="keyword" name="keyword" value="<%=keyword%>" style="width: 100%; border: 1px solid #bbb; border-radius: 8px; padding: 10px 12px; font-size: 14px;" placeholder="질문을 입력하세요">
                                ...
                                <div class="support-button text-center d-flex align-items-center justify-content-center mt-4 wow fadeInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInUp;">
                                    ...
                                    <a class="nav-link" href="<%=request.getContextPath()%>/qna/list" > 1:1 문의하기</a>
                                </div>
                        </div>
       ...
       %>                
                          ...
                          <div class="card border-0 wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                              <div class="card-header" id="headingOne">
                                  <h6 class="mb-0 collapsed" data-toggle="collapse" data-target="#collapse<%=i%>" aria-expanded="true" aria-controls="collapseOne"><%=qnaDto.getQna_title()%><span class="lni-chevron-up"></span></h6>
                              </div>
                              <div class="collapse" id="collapse<%=i%>" aria-labelledby="headingOne" data-parent="#faqAccordion">
                                  <div class="card-body">
                                      <p><%=qnaDto.getQna_contents()%></p>
                                  </div>
                              </div>
                          </div>
...
function goWrite(){
	   let frm = document.myform;
	   frm.action = "<%=request.getContextPath()%>/Qna/write";
	   frm.method="post";
	   frm.submit();
}
