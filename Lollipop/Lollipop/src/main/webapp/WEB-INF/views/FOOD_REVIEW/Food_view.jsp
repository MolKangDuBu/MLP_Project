...
<%
 	 FOOD_ReviewDto dto = (FOOD_ReviewDto)request.getAttribute("ReviewDto");
...
function goStore(store_key){
 ...
 function goList()
 {	
 	 location.href="<%=request.getContextPath()%>/FOOD_Review/list";
 }
function goReviewList()
{
	var frm = document.viewform;	
	frm.action="<%=request.getContextPath()%>/FOOD_Review/Reviewlist"
	frm.submit();
}
