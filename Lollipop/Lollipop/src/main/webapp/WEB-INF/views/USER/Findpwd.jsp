    ...
    <body>
        <div class="w3-content w3-container w3-margin-top">
            <div class="w3-container w3-card-4">
				...
				<section id="findForm" action="./member/find_password_member.do" method="post">
                    <p>
						<label>아이디</label> 
						<input class="w3-input" type="text" id="id" name="id" required placeholder="가입 아이디"> 
						<span id="id_check" class="w3-text-red"></span>
					</p>
					<p>
						<label>이메일 주소</label> 
						<input class="w3-input" type="email" id="id" name="id" required placeholder="가입할때 기입한 이메일 주소 (해당 이메일 주소로 인증메일을 보냅니다.)"> 
						<span id="id_check" class="w3-text-red"></span>
					</p>

                    <p class="w3-center">
                        <button type="submit" id="findBtn" class="w3-button w3-block w3-pink w3-ripple w3-margin-top w3-round">비밀번호 찾기</button>
