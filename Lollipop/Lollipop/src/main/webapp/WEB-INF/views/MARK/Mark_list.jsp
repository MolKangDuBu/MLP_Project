                                        ...
                                        <div _ngcontent-sc99="" class="text-container">
                                            <app-row _ngcontent-sc99="" class="title" _nghost-sc82="">
                                                ...
                                                <p>
                                                    ...
                                                    <img src="../../resources/img/markoff.png" style="width:25px; height:25px;" onclick="addMarkList('<%=tempDto.getStore_key()%>')">
                                                    <button id="btnAdd" type="button" onclick="addMarkList('<%=tempDto.getStore_key()%>')">즐겨찾기 추가</button>
                                                    <%} else { %>
                                                    <img src="../../resources/img/markon.png" style="width:25px; height:25px;" onclick="addMarkList('<%=tempDto.getStore_key()%>')">
