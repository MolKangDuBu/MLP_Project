      ...
      "item": "https://town.daangn.com/regions/6035"
                        ...
                        <div _ngcontent-sc102="" class="categories-container">
                            <app-category-chips _ngcontent-sc102="" _nghost-sc97="">
                                ...
                                <a _ngcontent-sc97="" routerlink="." queryparamshandling="merge"
                                    class="no-decoration" href="../REVIEW/Cafe_list.jsp">
                        ...
                        <div _ngcontent-sc102="" class="content-container">
                            <app-poi-item _ngcontent-sc102="" _nghost-sc99="">
                                ...
                                <a _ngcontent-sc99="" class="no-decoration container" href="<%=request.getContextPath()%>/Review/view">
                            ...
                            <app-poi-item _ngcontent-sc102="" _nghost-sc99="">
                                ...
                                <a _ngcontent-sc99="" class="no-decoration container" href="">
                                    <app-row _ngcontent-sc99="" _nghost-sc82="">
                                        <div _ngcontent-sc99="" class="img-container"><img _ngcontent-sc99=""
                                                src="https://search.pstatic.net/common/?autoRotate=true&quality=95&type=w750&src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMTAzMjlfMTMy%2FMDAxNjE3MDAxNDcwOTMx.aTqccdK9yP8aQjKvpCUeSqgTN85hWQLynpmluu_-G9wg.O9K6Shs09vKRAtOCyoFC5ey6DvEIKD1-rO6bSgDZL7Qg.JPEG.zzang5788%2F2.jpg"
                                                alt="랑데자뷰 강남점"></div>
                                        <div _ngcontent-sc99="" class="text-container">
                                            <app-row _ngcontent-sc99="" class="title" _nghost-sc82="">
                                                <p _ngcontent-sc99="" class="poi-name">랑데자뷰 강남점</p>
                                                <span _ngcontent-sc99="" class="short-address">역삼동;</span> 
                                                <p>
                                                    <img src="D:\user\Downloadss\MiniProject\aaa\MLP_Project\images\랑데자뷰 강남점.png">
                                                    <h6>5.0</h6>
                                                </p>
                                            </app-row>
                                            <div _ngcontent-sc99="" class="poi-info">
                                                <p _ngcontent-sc99="" class="address"> 서울특별시 강남구 봉은사로6길 39 1층 </p>
                                                <p _ngcontent-sc99="" class="branch"> </p>
                                            </div>
                                        </div>
                                    </app-row>
                            ...
                            <app-poi-item _ngcontent-sc102="" _nghost-sc99="">
                                ...
                                <a _ngcontent-sc99="" class="no-decoration container" href="">
                                    <app-row _ngcontent-sc99="" _nghost-sc82="">
                                        ...
                                        <div _ngcontent-sc99="" class="text-container">
                                            <app-row _ngcontent-sc99="" class="title" _nghost-sc82="">
                                                <p _ngcontent-sc99="" class="poi-name">아리랑고개 카페</p>
                                                <span _ngcontent-sc99="" class="short-address">역삼동;</span> 
                                                <p>
                                                    <img src="D:\user\Downloadss\MiniProject\aaa\MLP_Project\images\랑데자뷰 강남점.png">
                                                    <h6>5.0</h6>
