...
<form name = "writeform" id = "writeform" method="post" enctype = "multipart/form-data">
    ...
    <div style="width: 50%; margin: auto;">
     ...
     <%@include file="../include/nav.jsp" %>
      ...
      <input type ="hidden" id ="Qna_key" name= "Qna_key" value ="<%=dto.getQna_key()%>">
         ...
         <table class="table table-hover " _nghost-sc105="">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                   ...
                   <p>작성자</p>
                      ...
                      placeholder="이름을 입력하세요" value = "admin1" readonly>
                    </div>
                </td>
              </tr>      
              <tr>
              ...
              <tr>
                ...
                <td>
                <input type = "hidden"  class = "form-control" id = "qna_contents" name = "qna_contents"  value = "aa">
                    <div>
                    	 <p>내용</p>
...
window.onload = function(){
	   ...
	   CKEDITOR.instances.editor.setData('<%=dto.getQna_contents()%>');
	 
 };
 
function add(){
	
	   $("#qna_contents").val(CKEDITOR.instances.editor.getData());
		
	   var frm = document.writeform
	   //var frmData = new FormData(document.writeform); 
		frm.action = "<%=request.getContextPath()%>/qna/save";
		frm.method = "post";
		frm.submit();
