...
<body>
 ...
 <%@include file="../include/nav.jsp" %>
	...
	<form name="myform">
		<input type="hidden" name="qna_key" value="<%=dto.getQna_key()%>" >
    ...
    <div class="container" style="margin-top:80px">
        ...
        <table class="table table-hover " style="margin-top:30px;">
          ...
          <div class="container mt-3" style="text-align:right;">
            ...
            <%if(userid.equals(dto.getQna_id())) {%>
         	<a href="#none" onclick="goModify()" class="btn btn-secondary">수정</a>
         	<a href="#none" onclick="goDelete()" class="btn btn-secondary">삭제</a>
         	<% }%>
          </div>
           ...
           <table class="table" style="margin-top:20px" id="tbl_comment">
            ...
            <input type="hidden" name="qna_key" id="qna_key" value="<%=dto.getQna_key()%>" />
...
function goDelete()
{
	...
	{
		var frm = document.myform;
		frm.action="<%=request.getContextPath()%>/qna/delete";
		frm.submit();
	}
}
...
{
	var frm = document.myform;
	frm.action="${commonURL}/qna/reply";
	frm.submit();
}
