...
<head>
    ...
    <style ng-transition="poi-seo">
        ...
        .smb-info[_ngcontent-sc99] .stats[_ngcontent-sc99] .Marks[_ngcontent-sc99] {
            font-weight: 700;
            color: #2694ab
        }
        ...
        .Mark[_ngcontent-sc99] img[_ngcontent-sc99] {
            flex: none;
            width: 24px;
            height: 24px;
            border-radius: 12px
        ...
        .Mark[_ngcontent-sc99] p[_ngcontent-sc99] {
            margin-left: 8px;
            font-style: normal;
            font-weight: 400;
            font-size: 14px;
        ...
        <nav style ="background-color: rgba(252, 249, 249, 0.966);"> 
            <div class="container">
                <ol class="nav justify-content-end">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/User/login" style="color: #000000;">로그인</a>
                    </li>              
                    <li class="nav-item">
                        <a class="nav-link" href="/User/signup" style="color: #000000;">회원가입</a>
                    </li>
                    <li class="nav-item">
...
<!-- 여기부터 리스트 추가 -->
   			...
   			<%
            	List<MarkDto> list = (List<MarkDto>)request.getAttribute("MarkList");
           		for(MarkDto tempDto : list){
            %>
                                <a _ngcontent-sc99="" class="no-decoration container"  onclick= "goView('<%=tempDto.getMark_key()%>')">
                                    <app-row _ngcontent-sc99="" _nghost-sc82="">
                                        ...
                                        <div _ngcontent-sc99="" class="text-container">
                                            <app-row _ngcontent-sc99="" class="title" _nghost-sc82="">
                                                <p _ngcontent-sc99="" class="poi-name" ><%=tempDto.getMark_key()%></p>
                                              
                                                <p>
                                                    <img src="D:\OneDrive\바탕화~1-DESKTOP-OS4S3HI-7407125\풀스택 프로젝트\게시판디자인\images\별.PNG">
                                                    <h6><%=tempDto.getMark_like()%></h6>
                                                </p>
                                            </app-row>
...
<!-- 여기까지 리스트 추가 -->
                                ...
                                <div class="container mt-3" style="text-align:right;">
           						 <a href="<%=request.getContextPath()%>/Mark/write" 
