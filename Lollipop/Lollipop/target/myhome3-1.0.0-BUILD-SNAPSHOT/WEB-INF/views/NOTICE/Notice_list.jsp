...
<form name="myform" method="get">
    ...
    <div class="container" style="margin-top:80px">
        ...
        <table class="table table-hover ">
            ...
            List<NoticeDto> list = (List<NoticeDto>)request.getAttribute("boardList");
           	for(NoticeDto tempDto : list){
           	String reply="";
           	for(int i=0; i<tempDto.getDepth(); i++)
           		reply += "&nbsp;&nbsp;&nbsp;";
           	if(tempDto.getDepth()>0)
           		reply += "Re:";
...
function goPage(pg)
{
	...
	frm.pg.value=pg;///////////
	frm.method="get";
	frm.action="${pageContext.request.contextPath}/freeboard/list";
	frm.submit();
}
